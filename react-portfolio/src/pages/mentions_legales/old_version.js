  ...
  return (
    <HelmetProvider>
      <Container className="About-header">
        <Helmet>
          <meta charSet="utf-8" />
          <title> CGU & Politique de confidentialité</title>
        </Helmet>
        <Row className="mb-5 mt-3 pt-md-3">
          <Col lg="8">
            <h1 className="display-4 mb-4"> CGU & Politique de confidentialité</h1>
        ...
        <Row className=" sec_sp">
          ...
          <Col lg="7" className="d-flex align-items-center">
            <div>
              <p>Le Site est accessible gratuitement à tout Utilisateur ayant un accès à Internet et en tout lieu, 7j/7, 24h/24 sauf cas de force majeure, interruption programmée ou non et pouvant découler d’une nécessité de maintenance. En cas de modification, interruption ou suspension du Site, l'éditeur ne saurait être tenu responsable.</p>
        ...
        <Row className=" sec_sp">
          ...
          <Col lg="7" className="d-flex align-items-center">
            <div>
              ...
              <p> Les sources des informations diffusées sur le site Internet "www.MaLoWeb.fr" sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.</p> 
              <p> Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site "www.MaLoWeb.fr" ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.</p>
              <p> Le site Internet "www.MaLoWeb.fr" ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.</p>
        ...
        <Row className=" sec_sp">
          ...
          <Col lg="7" className="d-flex align-items-center">
            <div>
              <p> Le site "www.MaLoWeb.fr" peut-être amené à vous demander l’acceptation des cookies pour des besoins de statistiques et d'affichage. Un cookie est une information déposée sur votre disque dur par le serveur du site que vous visitez. Il contient plusieurs données qui sont stockées sur votre ordinateur dans un simple fichier texte auquel un serveur accède pour lire et enregistrer des informations . Certaines parties de ce site ne peuvent être fonctionnelles sans l’acceptation de cookies.</p>
            </div>
          </Col>
        </Row>
        <Row className=" sec_sp">
        ...
        <Row className="sec_sp">
          ...
          <Col lg="7" className="d-flex align-items-center">
            <div>
              ...
              <p> D’une façon générale, vous pouvez visiter ce site sur Internet sans avoir à décliner votre identité et à fournir des informations personnelles vous concernant. Cependant, nous pouvons parfois vous demander des informations. Par exemple, pour envoyer un message via le formulaire de contact (nom, prénom, adesse mail et téléphone si celui est indiqué dans le corps du message).Dans tous les cas, vous pouvez refuser de fournir vos données personnelles. Dans ce cas, vous ne pourrez pas utiliser les services du site, notamment celui de solliciter des renseignements sur notre société, ou de recevoir les lettres d’information.</p>
        ...
        <Row className="sec_sp">
          ...
          <Col lg="7" className="d-flex align-items-center">
            <div>
              <p>Les présentes conditions du site web cité, sont régies par les lois françaises et toutes contestations ou litiges qui pourraient naître de l'interprétation ou de l'exécution de celles-ci seront de la compétence exclusive des tribunaux dont dépend le siège social de la société. La langue de référence, pour le règlement de contentieux éventuels, est le français. Pour toute question relative à l’application des présentes CGU, vous pouvez joindre l’éditeur aux coordonnées inscrites dans la section "Editrice".</p>
            </div>
          </Col>
        </Row>
      </Container>
